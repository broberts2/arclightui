...
const Card: FC<PropTypes> = ({
  ...
  return (
    <Styles.Container
      ...
      className={`arclight-border-2 lg:arclight-border-2 arclight-border-background-tertiary`}
    >
      {bgElement ? (
      ...
      {[
        ...
        .map((el, i) =>
          items[i] ? (
            ...
            >
              <Styles.Diamond
                className={`arclight-border-background-tertiary arclight-border-2 lg:arclight-border-2`}
                lg={false}
