...
const Staff: FC<{
	...
	return (
		<Page
			fns={fns}
			backgroundImage={{
				src: "http://localhost:7000/static/media/jadevi.jpg",
				opacity: 0.5,
			}}
		>
			...
			<ProfilePage
				...
				panelImg={"http://localhost:7000/static/media/jadewukong3.jpg"}
				profileImg={`http://localhost:7000/static/media/dynasty2.png`}
				Panel={
							...
							cards={[
								{
									hoverComponent: (
										<img
											src={"http://localhost:7000/static/media/dynasty.png"}
			...
			<HeroPanel
				...
				cards={[
					{
						img: "http://localhost:7000/static/media/top-lane.png",
						subText: "Braer",
						bgImg: "http://localhost:7000/static/media/ornn.jpg",
					},
					{
						img: "http://localhost:7000/static/media/jungle.png",
						subText: "Khyroe",
						bgImg: "http://localhost:7000/static/media/leesin.png",
					},
					{
						img: "http://localhost:7000/static/media/mid-lane.png",
						subText: "Major1224",
						bgImg: "http://localhost:7000/static/media/malzahar.png",
					},
					{
						img: "http://localhost:7000/static/media/bot-lane.png",
						subText: "Jetgorilla",
						bgImg: "http://localhost:7000/static/media/zeri.jpg",
					},
					{
						img: "http://localhost:7000/static/media/support.png",
						subText: "Phortwenty",
						bgImg: "http://localhost:7000/static/media/yuumi.jpg",
					},
				].map((el: any) => ({
					bodyComponent: (
						<img
